...
data class User (
    ...
    @SerializedName("weeklyWorkingHours") val weeklyWorkingHours: Int? = 40,
    ...
    @SerializedName("forcedBreakAfter") var forcedBreakAfter: Double? = 0.0,
    @SerializedName("forcedBreakAfterOn") var forcedBreakAfterOn: Boolean? = false,
    @SerializedName("forcedEndAfter") var forcedEndAfter: Double? = 0.0,
    @SerializedName("forcedEndAfterOn") var forcedEndAfterOn: Boolean? = false,
